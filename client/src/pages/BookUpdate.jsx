...
function BookUpdate() {
  ...
  return (
    <>
      {loader && (
        <div className=" w-full flex justify-center items-center p-10 min-h-screen bg-zinc-900 ">
          <Hourglass
            visible={loader}
            height="90"
            width="90"
      ...
      {!loader && bookData && (
        <div className=" bg-zinc-900 min-h-screen h-auto pt-24 p-5 md:p-24">
          <div className=" bg-zinc-800 flex flex-col justify-center p-5 gap-5 rounded-xl w-full shadow-sm shadow-zinc-500 ">
            <h1 className=" text-3xl text-center font-semibold  text-zinc-400">
              Update Book
            </h1>
            <div className=" flex flex-col space-y-2  ">
              ...
              <input
                ...
                name="url"
                value={bookData.url}
                className=" bg-zinc-900  px-2 py-2 text-zinc-200  outline-none rounded-md"
                type="text"
            ...
            <div className="flex justify-center w-full">
              <button
                className="outline-none bg-blue-500 p-2 font-semibold text-lg text-zinc-900 rounded-md hover:bg-blue-600  transition-all duration-500"
                onClick={onSubmit}
              >
                Update Book
              </button>
