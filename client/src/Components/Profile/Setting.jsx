...
function Setting() {
  ...
  return (
    <>
      ...
      {userData && (
        <div className="  py-6 min-h-[70vh] h-auto w-auto ">
          ...
          <div className=" flex  items-center py-9 space-x-16">
            <div className=" flex flex-col gap-2">
              ...
              <p className=" bg-zinc-800 text-zinc-400 p-2 text-md rounded-md font-semibold text-center">
                {userData.username}
              </p>
            </div>
            <div className=" flex flex-col gap-2">
              <p className=" text-zinc-200 font-semibold">Email</p>
              <p className=" bg-zinc-800 text-zinc-400 p-2 px-4 text-md rounded-md font-semibold text-center">
                {userData.email}
              </p>
            </div>
          </div>
          <div className="  space-y-2">
            ...
            <textarea
              name="address"
              className="  bg-zinc-800 w-full outline-none p-4"
              rows={4}
              value={Value.address}
          ...
          <div className=" flex justify-center items-center w-full py-2">
            <button
              className=" p-2 rounded-md text-zinc-900 font-semibold text-md bg-blue-500 hover:bg-blue-600 transition-all duration-300"
